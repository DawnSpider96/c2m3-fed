...
from c2m3.utils.perm_graph import get_perm_dict, graph_permutations_to_layer_and_axes_to_perm
...
class CNNPermutationSpecBuilder(PermutationSpecBuilder):
    ...
    # Modified to suit the CNN stucture in c2m3/common/client_utils.py
    def create_permutation_spec(self, **kwargs) -> PermutationSpec:
        axes_to_perm = {
            **conv_axes("conv1", p_rows="P_conv1", p_cols=None, bias=True),
            **conv_axes("conv2", p_rows=None, p_cols="P_conv1", bias=True),
            **dense_layer_axes("fc1", p_rows="P_fc1", p_cols=None),
            **dense_layer_axes("fc2", p_rows="P_fc2", p_cols="P_fc1"),
            **dense_layer_axes("fc3", p_rows=None, p_cols="P_fc2"),
        }
